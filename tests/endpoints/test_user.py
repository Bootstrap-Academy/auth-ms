...
async def _get_users() -> list[models.User]:
    admin = await models.User.create("admin", "admin", "admin@example.com", "admin_password", True, True)
    admin.id = "admin"

    foo = await models.User.create("foo", "foo", "foo@example.com", "foo_password", True, False)
    foo.id = "foo"
    foo.mfa_enabled = True

    bar = await models.User.create("bar", "bar", "bar@example.com", None, True, False)
    bar.id = "bar"

    disabled = await models.User.create("disabled", "disabled", "disabled@example.com", None, False, False)
...
@pytest.mark.parametrize(
    "name_exists,email_exists,email_deliverable,password,oauth_token,admin,enabled,is_admin,"
    "open_registration,open_oauth_registration,recaptcha,expected_error",
    [
        (False, False, True, False, "none", False, True, False, True, True, "disabled", NoLoginMethodError),
        (False, False, True, True, "none", False, True, False, False, True, "disabled", RegistrationDisabledError),
        (
            False,
            False,
            True,
        ...
        (False, False, True, True, "none", False, True, False, True, True, "invalid", RecaptchaError),
        (False, False, False, True, "none", False, True, False, True, True, "disabled", InvalidEmailError),
        (True, False, True, True, "none", False, True, False, True, True, "disabled", UserAlreadyExistsError),
        (False, True, True, True, "none", False, True, False, True, True, "disabled", EmailAlreadyExistsError),
        (False, False, True, False, "invalid", False, True, False, True, True, "disabled", InvalidOAuthTokenError),
        (False, False, True, False, "linked", False, True, False, True, True, "disabled", RemoteAlreadyLinkedError),
        (False, False, True, True, "none", False, True, False, True, True, "valid", None),
        (False, False, True, False, "valid", False, True, False, True, True, "valid", None),
        (False, False, True, True, "valid", False, True, False, True, True, "valid", None),
        (False, False, True, True, "none", True, True, False, True, True, "valid", None),
        (False, False, True, True, "none", True, False, False, True, True, "valid", None),
        (False, False, True, True, "none", False, False, False, True, True, "valid", None),
        (False, False, True, True, "none", False, True, True, True, True, "valid", None),
        (False, False, True, True, "none", True, True, True, True, True, "valid", None),
        (False, False, True, True, "none", True, False, True, True, True, "valid", None),
        (False, False, True, True, "none", False, False, True, True, True, "valid", None),
    ],
)
@db_wrapper
async def test__create_user(
    ...
    data: dict[str, Any] = {
        "name": "username" if not name_exists else "admin",
        "display_name": "My Username",
        "email": "username@example.com" if not email_exists else "admin@example.com",
        "admin": admin,
        "enabled": enabled,
    }
    if password:
    ...
    mocker.patch(
        "api.endpoints.user.check_email_deliverability",
        AsyncMock(side_effect={data["email"]: email_deliverable}.__getitem__),
    )
